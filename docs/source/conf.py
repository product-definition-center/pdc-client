...
# Use the version from the source code over the may existed installed pdc.
sys.path.insert(1, os.path.dirname(__file__) + '/../..')

from pdc_client import get_version
...
pdc_client_version = get_version()
version = pdc_client_version.split('-')[0]
# The full version, including alpha/beta/rc tags.
release = pdc_client_version
...
htmlhelp_basename = 'PDCClientdoc'
...
latex_documents = [
  ('index', 'PDC_client.tex', u'PDC Client Documentation',
