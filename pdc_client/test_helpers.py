...
from pdc_client.compat import iteritems, PY3, StringIO


if PY3:
    # TODO Better way to define metaclass compatible with both Python 2 and 3
    from pdc_client.test_helpers_py3 import CLITestCase
